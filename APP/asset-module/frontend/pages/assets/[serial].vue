...
.svc-pill.ok { background: rgba(0,145,66,.16); color: #009142; }
...
.ebtn:hover:not(:disabled) { border-color: #009142; color: #009142; }
.ebtn.primary { background: #009142; border-color: #009142; color: var(--ink); }
...
.eos-badge.expired { color: #e06c6c; border-color: rgba(224,108,108,.5); background: rgba(224,108,108,.1); }
.eos-badge.upcoming { color: #d9a441; border-color: rgba(217,164,65,.5); background: rgba(217,164,65,.1); }
.eos-badge.ok { color: var(--good, #009142); border-color: rgba(0,145,66,.4); background: rgba(0,145,66,.08); }
...
.prov-line .tag {
  font-size: 10.5px; padding: 2px 8px; border: 1px solid var(--brand); color: var(--brand);
}
...
.cmp-row.diff { color: var(--warn, #d9a441); }
...
.cmp-flag { font-size: 10.5px; border: 1px solid var(--warn, #d9a441);
  color: var(--warn, #d9a441); padding: 1px 6px; }
</style>
