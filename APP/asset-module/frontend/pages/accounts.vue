...
.t-num { font-size: 30px; font-weight: 700; color: var(--brand, #009142); line-height: 1.1; font-variant-numeric: tabular-nums; }
...
.drill { position: absolute; right: 12px; bottom: 10px; font-size: 10px; color: var(--brand, #009142);
