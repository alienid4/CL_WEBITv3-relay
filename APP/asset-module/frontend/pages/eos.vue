...
.t-num { font-size: 26px; font-weight: 700; color: var(--brand, #009142); line-height: 1.1; }
...
.tab.active { color: var(--brand, #009142); border-bottom-color: var(--brand, #009142); font-weight: 600; }
...
.conf { font-size: 11px; color: var(--brand); }
.conf.weak { color: #d9a441; }
...
.lnk { background: none; border: none; color: var(--brand, #009142); text-decoration: underline;
...
.eos-toolbar .btn:hover { border-color: var(--brand, #009142); color: var(--brand, #009142); }
...
.chip.on { border-color: var(--brand, #009142); color: var(--brand, #009142); background: rgba(0,145,66,.1); font-weight: 600; }
...
/* 硬體型號分頁的「型號是猜的」標記（使用者 2026-08-13 要求，跟資產查詢頁的
   系統推測同精神）。 */
.guess-tag { font-size: 11px; color: var(--brand, #009142); cursor: help; margin-left: 4px; }
...
.rename-input:focus { border-color: var(--brand, #009142); outline: none; }
</style>
