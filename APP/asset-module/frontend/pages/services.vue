...
.drill { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; font-size: 13px;
  background: rgba(38,168,137,.08); border: 1px solid rgba(38,168,137,.28);
  border-radius: 10px; padding: 8px 12px; margin-bottom: 12px; }
.drill b { color: var(--brand, #26a889); }
...
.when .ok { color: var(--brand, #26a889); }
.when .bad { color: #e06c6c; }

.tbl tr.gone td { opacity: .5; }
.tag.infra { font-size: 10px; padding: 1px 6px; border-radius: 6px; margin-left: 6px;
  border: 1px solid var(--border); color: var(--muted); }
.pill { font-size: 11px; padding: 2px 8px; border-radius: 999px; }
.pill.done { background: rgba(38,168,137,.16); color: var(--brand, #26a889); }
.pill.open { background: rgba(230,170,60,.16); color: #d9a441; }
.pill.gone-pill { background: rgba(224,108,108,.16); color: #e06c6c; }
.exp { font-size: 12px; }
.exp.all { color: #d9a441; }
...
.foot-note code { background: rgba(255,255,255,.06); padding: 1px 5px; border-radius: 4px; }
</style>
