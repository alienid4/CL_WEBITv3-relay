    ...
    <div class="two">
      ...
      <section v-if="comp?.data_quality" class="card clean">
        ...
        <NuxtLink v-for="q in [
                    ...
                    { k: '疑似重複登記（組）', v: comp.data_quality.duplicate_groups, to: { path: '/assets', query: { show: 'duplicates' } }, tone: 'warn', why: `清掉可少 ${n(comp.data_quality.duplicate_extra_rows)} 筆（一機多系統／VIP 分列不算重複）` },
