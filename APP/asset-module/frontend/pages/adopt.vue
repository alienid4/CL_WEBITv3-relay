...
.link-btn { background: none; border: none; color: var(--brand); font-family: inherit;
...
.btn { font-family: inherit; font-size: 12.5px; font-weight: 700; padding: 9px 20px; border: none; background: var(--brand); color: var(--ink); cursor: pointer; }
...
.steps code { font-family: ui-monospace, Consolas, monospace; color: var(--brand); }
