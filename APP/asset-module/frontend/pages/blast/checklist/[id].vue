...
<template>
  <div class="topo">
    ...
    <p v-if="snapshot" class="lede">
      ...
      <InfoNote>這份清單所有登入的人都看得到同一份、改了就地存——分派給每個人負責幾列，開始打電話確認。</InfoNote>
    </p>
...
.syst.sy-doing { border-color: rgba(255,184,103,.35); } .syst.sy-doing b { color: var(--warn-text); }
.syst.sy-done { border-color: rgba(0,145,66,.35); } .syst.sy-done b { color: var(--brand-dark); }
...
.pill.sev-major { background: rgba(255,107,107,.15); color: var(--bad); }
.pill.sev-normal { background: rgba(15,23,42,.08); color: var(--ink-soft); }
.unreach { color: var(--bad); font-size: 11.5px; font-weight: 600; }
...
.sumtag.st-doing { background: rgba(255,184,103,.15); color: var(--warn-text); }
.sumtag.st-ok { background: rgba(0,145,66,.15); color: var(--brand-dark); }
.sumtag.st-bad { background: rgba(255,107,107,.15); color: var(--bad); }
.sumtag.st-warn { background: rgba(224,176,96,.15); color: var(--warn-text); }
...
.sel.status.st-doing { color: var(--warn-text); border-color: rgba(255,184,103,.4); }
.sel.status.st-ok { color: var(--brand-dark); border-color: rgba(0,145,66,.4); }
.sel.status.st-bad { color: var(--bad); border-color: rgba(255,107,107,.4); }
.sel.status.st-warn { color: var(--warn-text); border-color: rgba(224,176,96,.4); }
