...
.filter-chip .fc-dot { width: 7px; height: 7px; border-radius: 50%; background: #009142;
...
.note-view:hover { color: var(--brand, #009142); }
.note-add { color: var(--muted); opacity: .6; font-size: 11px; }
.note-input { background: var(--card); border: 1px solid var(--brand, #009142); color: inherit;
  border-radius: 6px; padding: 3px 6px; font-size: 12px; width: 120px; font-family: inherit; }
.note-save { background: var(--brand, #009142); border: none; color: #04120e; border-radius: 6px;
...
.cell.ok { background: rgba(0,145,66,.16); color: #009142; }
...
.fsel.on { border-color: var(--brand, #009142); color: var(--brand, #009142); }
