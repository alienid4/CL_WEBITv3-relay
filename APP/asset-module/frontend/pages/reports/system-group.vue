...
/* 每個數字都是連結——這是「可追」的入口 */
.n { color: var(--brand); cursor: pointer; text-decoration: none; }
...
.eos-expired { color: #dc2626; background: rgba(255,107,107,.14); }
.eos-upcoming { color: #e0b060; background: rgba(224,176,96,.16); }
.eos-ok { color: var(--brand); background: rgba(0,145,66,.14); }
.eos-unknown { color: var(--ink-soft); background: rgba(15,23,42,.06); }
.eos-nodate { color: #7fb4d9; background: rgba(127,180,217,.14); }

.bapend { color: #dc2626; font-size: 11.5px; font-weight: 600; }
.notfound { opacity: .75; }
