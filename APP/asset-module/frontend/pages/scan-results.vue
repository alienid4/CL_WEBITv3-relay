...
// 這裡看的是「掃描側」的事實（這次網路上活著的主機），跟資產查詢（ICA 登記側）不同；
...
<template>
  <div>
    ...
    <p class="lead">
      最新一次掃描中「有回應（存活）」的主機。這是網路上的實況，不是 ICA 登記清單。
...
.fp .tag.vm { background: rgba(255, 184, 103, 0.16); color: #ffb867; }
.fp .tag.vendor { background: rgba(38, 168, 137, 0.14); color: #26a889; }
.fp .tag.os { background: rgba(47, 214, 172, 0.14); color: #2fd6ac; }
...
.link { font-size: 12.5px; color: #26a889; text-decoration: none; }
