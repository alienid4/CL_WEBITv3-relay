...
.tab.on { border-color: #009142; color: #009142; background: rgba(0,145,66,0.1); }
...
.pill.open { background: rgba(255, 184, 103, 0.16); color: #b45309; }
.pill.done { background: rgba(0,145,66,0.14); color: #009142; }
...
.fp .tag.vm { background: rgba(255, 184, 103, 0.16); color: #b45309; }
.fp .tag.vendor { background: rgba(0,145,66,0.14); color: #009142; }
.fp .tag.os { background: rgba(0,145,66,0.14); color: #009142; }
.fp-sub { font-size: 11px; margin-top: 3px; }
.dl { color: inherit; text-decoration: none; border-bottom: 1px dotted rgba(0,145,66,.45); }
.dl:hover { color: #009142; border-bottom-color: #009142; }
.link { font-size: 12.5px; color: #009142; text-decoration: none; }
