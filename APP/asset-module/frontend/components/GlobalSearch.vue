...
.gs:focus-within { border-color: rgba(47,214,172,.5); box-shadow: 0 0 0 3px rgba(47,214,172,.1); }
...
.panel { position: absolute; top: calc(100% + 8px); left: 0; right: 0; z-index: 60;
  background: var(--card, #0f1a17); border: 1px solid var(--border); border-radius: 12px;
...
.ghd { font-size: 10px; text-transform: uppercase; letter-spacing: 1.2px; color: #5f7d72; padding: 8px 10px 4px; }
...
.row.on { background: rgba(47,214,172,.12); }
.row .t { font-size: 13px; }
.row .s { font-size: 11px; color: var(--muted); }
.more { width: 100%; text-align: left; background: none; border: none; color: var(--brand, #26a889);
